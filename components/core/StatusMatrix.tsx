          ...
          >
            ...
            <div className="flex items-center gap-3 relative z-10">
              ...
              <div className="flex flex-col min-w-0">
                ...
                <span className="text-[10px] text-gray-400 font-mono truncate uppercase flex items-center gap-1">
                  {status}
            ...
            <div className={`
                relative w-full bg-black border-x border-b border-cyber-gray/50 rounded-b-sm shadow-[inset_0_0_15px_rgba(0,0,0,1)] overflow-hidden
                origin-top transition-all duration-500
                ${hasData ? 'animate-tv-on mt-3' : 'h-0 opacity-0 mt-0 scale-y-0'}
            `}
            style={{ height: hasData ? '6rem' : '0' }}
            >
                {/* Scanline Overlay */}
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent via-cyber-neon/5 to-transparent animate-scanline z-20 pointer-events-none"></div>
                ...
                <div className="p-2 font-mono text-[9px] leading-3 h-full flex flex-col justify-end relative z-10">
                  <div className="text-cyber-neon/80 font-medium tracking-tight break-all whitespace-pre-wrap overflow-hidden" style={{ maskImage: 'linear-gradient(to bottom, transparent, black 20%)' }}>
